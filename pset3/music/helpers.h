...
//  {
//       takes the fraction represented as a string as its input (ex. "1/8")
//       output an int, return an 8th long, ex. function would return 1
//  }
...
//       return fequency as an integer value in Hertz
//  }
