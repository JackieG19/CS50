...
int frequency(string note)
{
    ...
    double freq = 0.0; // determine the frequency of note in the given octive
    ...
    if(octave > 4) // Loop to shift octave
    {
    ...
    int ret = round(freq); // Return frequency value as an int
    return ret;
}
